#!/usr/bin/env bash
# ASPHODEL_OUTBREAK_V1 in-engine gate: start the live Python bridge,
...
BUNDLE="${1:-houston}"
CITIZEN="${2:-42}"
TRACE="${3:-artifacts/outbreak_v1/godot_probe_trace.json}"
GAME_DT="${GAME_DT:-0.1}"
GODOT="${GODOT:-godot}"
